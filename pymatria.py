...
if __name__ == "__main__":
    ...
    try:
        ...
        print("The gematria of the number", user_input, "is", hebrew_word)
        ...
        try:
            ...
            if corresponding_hebrew_words:
                print(f"The numerical value {number} corresponds to the following Hebrew words found in Bereshit:")
                try:
